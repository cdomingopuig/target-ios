[![Build Status](https://img.shields.io/travis/rootstrap/target/master.svg)](https://travis-ci.org/rootstrap/target)
[![Maintainability](https://api.codeclimate.com/v1/badges/21b076c80057210cda75/maintainability)](https://codeclimate.com/github/rootstrap/target/maintainability)
[![Test Coverage](https://api.codeclimate.com/v1/badges/21b076c80057210cda75/test_coverage)](https://codeclimate.com/github/rootstrap/target/test_coverage)
[![License](https://img.shields.io/github/license/rootstrap/target.svg)](https://github.com/rootstrap/target/blob/master/LICENSE.md)
...
- [**feature/observe_root_vc**](https://github.com/rootstrap/target/tree/feature/observe_root_vc): Detecting when **rootViewController** gets loaded.
- [**feature/util_gradients**](https://github.com/rootstrap/target/tree/feature/util_gradients): Helper methods to easily add **color gradients**.
- [**feature/paginated_collections**](https://github.com/rootstrap/target/tree/feature/paginated_collections): Adds **paginated** subclasses of **UITableView** and **UICollectionView**.
- [**feature/mvvm+rxswift**](https://github.com/rootstrap/target/tree/feature/mvvm%2Brxswift) in case you want to work with **RxSwift** and **MVVM**.
...
**iOS Base** is maintained by [Rootstrap](http://www.rootstrap.com) with the help of our [contributors](https://github.com/rootstrap/target/contributors).
