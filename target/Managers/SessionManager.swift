...
class SessionManager: NSObject {
  ...
  static var currentSession: Session? {
    get {
      if
        let data = UserDefaults.standard.data(forKey: "target-session"),
    ...
    set {
      ...
      UserDefaults.standard.set(session, forKey: "target-session")
    }
  }
  
  class func deleteSession() {
    UserDefaults.standard.removeObject(forKey: "target-session")
  }
